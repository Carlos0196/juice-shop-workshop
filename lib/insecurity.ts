...
const placeholderPublic = process.env.PLACEHOLDER_PUBLIC_KEY as string

export const publicKey = fs ? fs.readFileSync('encryptionkeys/jwt.pub', 'utf8') : placeholderPublic
...
const hmac_secret = process.env.HMAC_SECRET as BinaryLike
